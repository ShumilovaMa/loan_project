...
window.addEventListener("DOMContentLoaded", function () {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.video .play', '.overlay').init();
    ...
    value: function bindTriggers() {
      ...
      this.officer.querySelector('.plus').addEventListener('click', function () {
        ...
        if (_this.counter !== _this.items.length - 2) {
          ...
          _this.items[_this.items.length - 1].remove();
        }
      });
    }
  }, {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          form.parentNode.appendChild(statusMessage); //помещаем элемент на страницу к родительскому блоку(form)
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function createPlayer(url) {
      //код взят из документации youtube
    ...
    value: function onPlayerStateChange(state) {
      //получаем первого родителя с данным селектором 
      try {
...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    _this.prevBtn = document.querySelectorAll('.prevmodule');
    _this.nextBtn = document.querySelectorAll('.nextmodule');
    return _this;
  }
  ...
  _createClass(MainSlider, [{
    ...
    key: "toggleBtn",
    value: function toggleBtn(btns, n) {
      var _this3 = this;
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          _this4.showSlides(_this4.slideIndex);
        });
      });
    }
  }, {
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function activateAnimation() {
      ...
      [this.container, this.prev, this.next].forEach(function (item) {
        item.addEventListener('mouseleave', function () {
          _this4.deactivateAnimation();
        });
      });
    }
  }, {
